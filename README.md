...
# 📖 [try-to-connect-to-api] <a name="about-project"></a>

**try-to-connect-to-api** is a simple website which fecth data, get and post users information to an api.
...
```sh
  cd my-folder
  git clone https://github.com/Matthieu96Code/try-to-connect-to-api.git
```
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/try-to-connect-to-api/issues)
